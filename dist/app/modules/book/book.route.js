...
router
  ...
  .post(
    (0, validateRequest_1.validateRequest)(
      book_validation_1.BookValidation.createBookSchema
    ),
    checkAuth_1.default,
...
router
  ...
  .patch(
    (0, validateRequest_1.validateRequest)(
      book_validation_1.BookValidation.updateBookSchema
    ),
    checkAuth_1.default,
...
router
  ...
  .post(
    (0, validateRequest_1.validateRequest)(
      book_validation_1.BookValidation.createReviewSchema
    ),
    checkAuth_1.default,
    book_controller_1.BookController.createReview
  )
