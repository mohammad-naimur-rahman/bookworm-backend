...
const getAllBooksFromDB = (filters, paginationOptions) =>
...
const updateBookInDB = (id, payload, email) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const bookCreatorId = mongoose_1.Types.ObjectId.prototype.toString.call(
      book.user
    )
...
const deleteBookFromDB = (id, email) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const book = yield book_model_1.Book.findById(id)
    if (!book) {
      throw new ApiError_1.default(
...
const createCommentInDB = (id, payload, email) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const book = yield book_model_1.Book.findById(id)
    if (!book) {
      throw new ApiError_1.default(
    ...
    const commenterId = mongoose_1.Types.ObjectId.prototype.toString.call(
      user._id
    )
    const updatedBook = yield book_model_1.Book.findByIdAndUpdate(
      book._id,
      {
        $push: {
